...
while(1):
    ...
    if ret == True: 
        ...
        # Draw a green rectangle on the current image (Mean shift + Hough Transform)
        ret, track_window = cv2.meanShift(hough_vote, track_window, term_crit)
        x,y,h,w = track_window
        frame_tracked = cv2.rectangle(frame, (x,y), (x+h,y+w), (0,255,0) ,2)
